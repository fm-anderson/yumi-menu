    ...
    <header className="flex w-full justify-between px-2">
      <div className="btm-nav">
        <button>
          ...
          {/* <span className="btm-nav-label">Fresh</span> */}
        </button>
        <button>
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          {/* <span className="btm-nav-label">Cooked</span> */}
        </button>
        ...
        <button>
          ...
          {/* <span className="btm-nav-label">Joys</span> */}
        </button>
        <button>
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          {/* <span className="btm-nav-label">Party</span> */}
        </button>
      </div>
    </header>
  );
